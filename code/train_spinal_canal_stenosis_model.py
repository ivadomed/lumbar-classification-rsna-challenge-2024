...
We focus on Spinal Canal Stenosis diagnosis.
        ...
        for batch_data in tqdm(train_loader):
            ...
            try:
                ...
                writer_train.add_scalar(
                    "train_loss", total_loss, epoch_len * epoch + step
                )
...
def main():
    ...
    val_data = SpinalCanalStenosisDataset(
        root_dir=root_dir,
        vol_paths=val_vols,
        seg_paths=val_seg,
        transform=transform,
    ...
    test_data = SpinalCanalStenosisDataset(
        root_dir=root_dir,
        vol_paths=test_vols,
        seg_paths=test_seg,
        transform=transform,
