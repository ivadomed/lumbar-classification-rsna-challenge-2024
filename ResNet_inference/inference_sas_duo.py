...
def parse_args():
    ...
    parser.add_argument('--model_paths', nargs=2, required=True, help="Paths to two models for ensembling")
...
def inference_and_evaluate(device, data_dir, csv_file, model_paths, batch_size=4, layers=[3, 4, 6, 3]):
