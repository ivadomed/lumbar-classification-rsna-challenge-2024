...
def run_inference(device, model_weights_path, val_dir, csv_file, batch_size=4):
    ...
    val_dataset_l, val_dataset_r = prepare_data(val_dir, csv_file, transform)
...
def main():
    ...
    model_weights_path = "nfn_t1_t2_model_layers_[3, 4, 6, 3]_epochs_60_lr_0.0001_augmentation_True_wd_0.0001.pth"  # Specify the model weights path
